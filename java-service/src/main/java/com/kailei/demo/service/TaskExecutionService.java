...
public class TaskExecutionService {
    ...
    public TaskAction confirmAction(String planId, String userId, TaskAction action, String operatorUserId) {
        return confirmAction(planId, null, userId, action, operatorUserId);
    }

    public TaskAction confirmAction(String planId, String traceId, String userId, TaskAction action, String operatorUserId) {
        if (stateMachineService.canSchedule(action)) {
            ...
            executionLogRepository.logStateChange(planId, traceId, action, next, operatorUserId);
            return next;
        }
        return executeNow(planId, traceId, userId, action, operatorUserId);
    }

    public TaskAction confirmAction(String planId, TaskAction action, String operatorUserId) {
        return confirmAction(planId, null, operatorUserId, action, operatorUserId);
    }

    public TaskAction executeNow(String planId, String userId, TaskAction action, String operatorUserId) {
        return executeNow(planId, null, userId, action, operatorUserId);
    }

    public TaskAction executeNow(String planId, String traceId, String userId, TaskAction action, String operatorUserId) {
    ...
    public TaskAction executeNow(String planId, TaskAction action, String operatorUserId) {
        return executeNow(planId, null, operatorUserId, action, operatorUserId);
    }
}
