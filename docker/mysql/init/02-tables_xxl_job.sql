...
INSERT IGNORE INTO `xxl_job_group`(`id`, `app_name`, `title`, `address_type`, `address_list`, `update_time`) VALUES (1, 'ai-secretary-demo-executor', 'AI秘书执行器', 0, NULL, NOW());
INSERT IGNORE INTO `xxl_job_info`(`id`, `job_group`, `job_desc`, `add_time`, `update_time`, `author`, `alarm_email`, `schedule_type`, `schedule_conf`, `misfire_strategy`, `executor_route_strategy`, `executor_handler`, `executor_param`, `executor_block_strategy`, `executor_timeout`, `executor_fail_retry_count`, `glue_type`, `glue_source`, `glue_remark`, `glue_updatetime`, `child_jobid`, `trigger_status`, `trigger_last_time`, `trigger_next_time`) VALUES (1, 1, 'AI Secretary 到期任务扫描', NOW(), NOW(), 'AI Secretary', '', 'CRON', '0/10 * * * * ? *', 'DO_NOTHING', 'FIRST', 'aiSecretaryDispatchDueTasks', '', 'SERIAL_EXECUTION', 30, 0, 'BEAN', '', 'GLUE代码初始化', NOW(), '', 1, 0, 0);
